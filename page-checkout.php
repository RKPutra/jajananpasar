	...
	<div class="row row-checkout">
			    ...
			    <div class="form-group">
			  	...
			  	<div class="col-sm-8 metode-pembayaran">
			  		<p>
			  			...
			  			Lalu kirimkan bukti transfer ke <strong>info@jajananpasar.id</strong> atau gunakan form konfirmasi pembayaran yang telah kami sediakan <a href="#"><strong>disini</strong></a>. 
			  		</p>
			  	</div>
		...
		<div class="col-sm-3 pesanan">
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="col-sm-3">
						<img src="<?php echo get_template_directory_uri() . '/images//lemper.jpg'; ?> " class="img-circle" width="50px" height="50px">
					</div>
					<div class="col-sm-5">
						<h5>Lemper Ayam</h5>
					</div>
